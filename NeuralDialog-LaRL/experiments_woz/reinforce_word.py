...
def main():
    ...
    # original
    pretrained_folder = '2020-05-11-11-55-57-sl_word'
    pretrained_model_id = 50

    # multiwoz 2.0
    # pretrained_folder = '2020-05-09-16-32-59-sl_word'
    # pretrained_model_id = 47
    
    # multiwoz 2.1
    # pretrained_folder = '2020-05-08-01-27-47-sl_word'
    # pretrained_model_id = 48
